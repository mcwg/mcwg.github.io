...
*  [Definition of functions and function notation](assessment1.md). 
    
*  [Finding inputs and outputs of functions](assessment2.md) from expressions, graphs, tables. 

*  [Slopes](assessment3.md)
...
*  [Finding inputs and outputs of functions](https://github.com/mcwg/DATA/blob/master/coreqWorksheets/psec2-1coreq-sols.pdf) from expressions, graphs, tables for use in computing rates of change. Version without solutions also available [here](https://github.com/mcwg/DATA/blob/master/coreqWorksheets/psec2-1coreq.pdf).
